...
function renderSchedule(){
  ...
  document.querySelectorAll('.match-card').forEach(card=>card.querySelectorAll('.match-teams span').forEach(team=>{if(team.textContent.includes('セレッソ大阪')){card.classList.add('cerezo-match');team.classList.add('cerezo-team')}}));
